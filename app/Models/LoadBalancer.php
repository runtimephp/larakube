...
use Database\Factories\LoadBalancerFactory;
 ...
 * @property-read string|null $external_load_balancer_id
 * @property-read string|null $ip
 * @property-read InfrastructureStatus $status
 * @property-read Infrastructure $infrastructure
 */
final class LoadBalancer extends Model
{
    /** @use HasFactory<LoadBalancerFactory> */
    use HasFactory;
    ...
    public function casts(): array
    {
        return [
            ...
            'name' => 'string',
            'external_load_balancer_id' => 'string',
            'ip' => 'string',
