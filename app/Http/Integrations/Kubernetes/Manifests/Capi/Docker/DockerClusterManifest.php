...
final readonly class DockerClusterManifest implements ManifestContract
{
    public function __construct(
        public ManifestMetadata $metadata,
    ) {
        if ($this->metadata->namespace === null || mb_trim($this->metadata->namespace) === '') {
            throw new InvalidArgumentException('DockerCluster manifests require a namespace.');
        }
    }
    ...
    {
        return Kind::DockerCluster;
    }

    public function resource(): string
    {
        return 'dockerclusters';
    }
