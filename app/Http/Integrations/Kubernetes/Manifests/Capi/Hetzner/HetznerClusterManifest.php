...
final readonly class HetznerClusterManifest implements ManifestContract
{
    public function __construct(
        public ManifestMetadata $metadata,
        public HetznerClusterSpec $spec,
    ) {
        if ($this->metadata->namespace === null || mb_trim($this->metadata->namespace) === '') {
            throw new InvalidArgumentException('HetznerCluster manifests require a namespace.');
        }
    }
    ...
    {
        return Kind::HetznerCluster;
    }

    public function resource(): string
    {
        return 'hetznerclusters';
    }
